...
if strcmp( train_func_name, 'learn_HBF1_SGD')
    ...
    addpath(p);
elseif strcmp( train_func_name, 'learn_HSig_SGD') || strcmp( train_func_name, 'learn_HReLu_SGD') || strcmp( train_func_name, 'learn_HSig_SGD') || strcmp( train_func_name, 'learn_HTanh_SGD')
